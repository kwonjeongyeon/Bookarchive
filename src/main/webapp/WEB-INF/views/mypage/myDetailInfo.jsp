...
<script>
   ...
   window.onload=function()
    ...
    function selectBoxInit(){
     ...
     var tel1='${memberInfo.tel1 }';  //유선전화의 국번 저장
     var hp1='${memberInfo.hp1}';  //휴대폰 국번 저장
			...
			<table>
				<tbody>
					...
					<tr class="dot_line">
						...
						<td>
							<!-- 유선전화 국번 선택 셀렉트 박스 --> <select name="tel1" id="tel1">
							...
							name="tel3" value="${memberInfo.tel3 }">
						</td>
						<td><input type="button" value="수정하기"
					...
					<tr class="dot_line">
						...
						<td>
							<!-- 휴대전화 국번 선택 셀렉트 박스 --> <select name="hp1" id="hp1">
								<option>없음</option>
